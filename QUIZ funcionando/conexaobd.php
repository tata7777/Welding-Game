...
function conectabd()
{
  ...
  $db->query("CREATE TABLE IF NOT EXISTS scores (name varchar(80), university varchar(80), country varchar(80), score integer)"); //colocar language e data tambem e o score deve começar com 0
  return $db;
}
