<?php
    if(isset($_POST['submit'])){
       /* print_r('Nome:'. $_POST['name']);
        ...
        print_r('<br>');
        print_r('Institutional:'. $_POST['institutional']);
        print_r('<br>');
        print_r('Pais:'. $_POST['country']);
        print_r('<br>');
        */
        ...
        $email = $_POST['email'];
        $institutional = $_POST['institutional'];
        $country = $_POST['country'];

        $result = mysqli_query($conexao, "INSERT INTO (nome, password, email, institutional, country) 
        VALUES( $nome, $password, $email, $institutional, $country) ")/*de acordo com a tabela criada - tem que completar */
    ...
    <div class="box">
        <form action="formulario.php" method = "POST">
            <fieldset>
                ...
                <div class="login">
                    <br><strong>Already have an account? </strong> <a href="login.php">Log In</a>
                </div>
            </fieldset>
        </form>
    </div>
